/* src/config/rapid-config.h.  Generated from rapid-config.h.in by configure.  */
/* src/config/rapid-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/rapidpay/rapid/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rapid Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rapid Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rapidcore"
